...
<Dialog bind:open selection aria-labelledby="list-title" aria-describedby="list-content">
	...
	<Content id="mandatory-content">
		<Card padded>
			...
			<br />
			<Textfield textarea input$maxlength={2500} bind:value label="Content">
				<CharacterCounter slot="internalCounter">0 / 100</CharacterCounter>
			</Textfield>
			<br />
            <Textfield variant="outlined" bind:value={valueA} label="Cover URL">
				<HelperText slot="Cover URL">Helper Text</HelperText>
			</Textfield>
			<br />
